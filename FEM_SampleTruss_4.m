...
%L = [6; 6*sqrt(3); 12];
L = [5;4;sqrt(41);6;sqrt(29);6;sqrt(41);6;sqrt(29);6;sqrt(41);6;sqrt(29);6;sqrt(41);6;sqrt(29);6;sqrt(41);6;sqrt(29)]
%theta array corresponds to lengths, note it is from node 1 to node 2
%theta = [60; 150; 0]; 
theata = [90;0;atand(5/4);0;atand(-5/2);0;atand(5/4);0;atand(-5/2);0;atand(5/4);0;atand(-5/2);0;atand(5/4);0;atand(-5/2);0;atand(5/4);0;atand(-5/3)]
